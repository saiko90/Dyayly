  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="fixed top-16 md:top-20 inset-x-4 md:inset-x-0 mx-auto z-50 max-w-5xl md:max-w-fit px-6 py-4 rounded-full border border-white/40 bg-white/20 backdrop-blur-2xl shadow-lg flex justify-between items-center"
      >
