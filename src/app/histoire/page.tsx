...
export default function HistoirePage() {
  ...
  return (
    <main className="relative min-h-screen text-stone-900 selection:bg-purple-100 overflow-hidden pb-24">
      ...
      {/* SECTION CENTRALE : Le cœur du message (Effet Cristal) */}
      <section className="relative z-10 px-4 md:px-6 max-w-4xl mx-auto mb-32">
        ...
        >
          {/* Halos lumineux internes à la carte */}
          ...
          <div className="relative z-10 space-y-10">
            <h2 className="text-3xl md:text-5xl font-serif italic text-stone-800 leading-snug">
      ...
      {/* SECTION FINALE : Ensemble créons... */}
